...
* Переклади модів:
  ...
  * WolfoFixes
  * WolfoQoL
    * Відмінювання назв Boosted та Corrupted здібностей Шефа та Породження Порожнечі
* Тепер переклади більшості модів завантажуються через вбудований завантажувач токенів, файли перекладу зазначені у LanguageAPIWhitelist.conf будуть завантажені використовуючи R2API.Language.
* Перероблено систему збірки проєкту (Просто хизуюся)

### 1.5.0
* Файли оновлено до версії гри 1.4.1#912*
* Повернення жіночих родів еліток!
* Якщо встановлено лише переклад, призматичні випробування та їхні таблиці рекордів увімкнені
* Переклад вмісту «Seekers of the Storm»
* Переклад вмісту «Alloyed Collective»
* Переклади модів:
  * SimulacrumAdditions
  * WLoopWeather
  * UmbralMithrix
  * FathomlessVoidling
  * HalcyonKnight
* Багато технічних покращень
* Виправлення купи помилок у перекладі
* Makefiles are cool! Більшість ручної праці для оновлення і пакування перекладу тепер атоматизовано.
* Особлива подяка Івану (@opius_prime_141 у Discord) за величезний вклад у переклад (39 712 слів на момент написання)

### 1.4.11
* Я не знаю як я умудрився не запакувати сам мод у попередньому релізі...

### 1.4.9
* Змінено форматування цього списку
* Хотфікс на К?яро (тепер показується К'яро, як і має бути)
