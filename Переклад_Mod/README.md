...
Цей переклад підтримується тільки як мод і не може бути встановлений в теку Language без попередніх змін. Але навіть якщо ви дуже захочете, українські символи тепер відсутні у грі повністю, подякуйте Gearbox.
...
* Переклад зі сторони мода:
	...
	* [Rocket](https://thunderstore.io/package/EnforcerGang/Rocket/) (Має бути)
